...
int main()
    {
        ...
        unsigned int fragmentShader_Orange, fragmentShader_Yellow;
        ...
        checkFragShaderCompilation(fragmentShader_Orange);
        ...
        checkFragShaderCompilation(fragmentShader_Yellow);
        
        // create shader program and link shaders
        unsigned int shaderProgram_Orange, shaderProgram_Yellow;
        ...
        checkShaderProgCompilation(shaderProgram_Orange);
        ...
        checkShaderProgCompilation(shaderProgram_Yellow);

        glDeleteShader(vertexShader);
        glDeleteShader(fragmentShader_Orange);
        glDeleteShader(shaderProgram_Yellow);
